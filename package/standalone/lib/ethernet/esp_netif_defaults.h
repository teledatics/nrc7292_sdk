...
extern "C"
{
  ...
  //
  // Macros to assemble master configs with partial configs from netif, stack
  // and driver
  //

#define ESP_NETIF_INHERENT_DEFAULT_WIFI_STA()                                  \
  {                                                                            \
    .flags = (esp_netif_flags_t)(ESP_NETIF_DHCP_CLIENT | ESP_NETIF_FLAG_GARP | \
                                 ESP_NETIF_FLAG_EVENT_IP_MODIFIED),            \
    ESP_COMPILER_DESIGNATED_INIT_AGGREGATE_TYPE_EMPTY(mac)                     \
      ESP_COMPILER_DESIGNATED_INIT_AGGREGATE_TYPE_EMPTY(ip_info)               \
        .get_ip_event = IP_EVENT_STA_GOT_IP,                                   \
    .lost_ip_event = IP_EVENT_STA_LOST_IP, .if_key = "WIFI_STA_DEF",           \
    .if_desc = "sta", .route_prio = 100                                        \
  }

#ifdef CONFIG_ESP_WIFI_SOFTAP_SUPPORT
#define ESP_NETIF_INHERENT_DEFAULT_WIFI_AP()                                   \
  { .flags =                                                                   \
      (esp_netif_flags_t)(ESP_NETIF_DHCP_SERVER | ESP_NETIF_FLAG_AUTOUP),      \
    ESP_COMPILER_DESIGNATED_INIT_AGGREGATE_TYPE_EMPTY(mac).ip_info =           \
...
#define ESP_NETIF_DEFAULT_ETH()                                                \
  {                                                                            \
    .base = ESP_NETIF_BASE_DEFAULT_ETH, .driver = NULL,                        \
...
#define ESP_NETIF_DEFAULT_WIFI_AP()                                            \
  {                                                                            \
    .base = ESP_NETIF_BASE_DEFAULT_WIFI_AP, .driver = NULL,                    \
...
#define ESP_NETIF_DEFAULT_WIFI_STA()                                           \
  {                                                                            \
    .base = ESP_NETIF_BASE_DEFAULT_WIFI_STA, .driver = NULL,                   \
...
#define ESP_NETIF_DEFAULT_PPP()                                                \
  {                                                                            \
    .base = ESP_NETIF_BASE_DEFAULT_PPP, .driver = NULL,                        \
...
#define ESP_NETIF_DEFAULT_SLIP()                                               \
  {                                                                            \
    .base = ESP_NETIF_BASE_DEFAULT_SLIP, .driver = NULL,                       \
...
#define ESP_NETIF_NETSTACK_DEFAULT_WIFI_STA                                    \
...
#define ESP_NETIF_NETSTACK_DEFAULT_OPENTHREAD                                  \
  _g_esp_netif_netstack_default_openthread
  ...
  //    common behavioural patterns for common interfaces such as STA, AP, ETH,
  //    PPP
  //
...
#define ESP_NETIF_DEFAULT_OPENTHREAD()                                         \
  {                                                                            \
    .base = ESP_NETIF_BASE_DEFAULT_OPENTHREAD, .driver = NULL,                 \
 ...
 */
#define ESP_NETIF_BASE_DEFAULT_OPENTHREAD                                      \
  &_g_esp_netif_inherent_openthread_config

  extern const esp_netif_netstack_config_t*
    _g_esp_netif_netstack_default_openthread;
  extern const esp_netif_inherent_config_t
    _g_esp_netif_inherent_openthread_config;
