...
extern "C"
{
   ...
   *   - ESP_OK on success
   *   - ESP_ERR_INVALID_STATE if the given handler hasn't been registered
   * before
   */
   ...
   * Peripherals (except for Wi-Fi, BT, UART0, SPI1, and legacy timers) are not
   ...
   * @return See description of esp_reset_reason_t for explanation of each
   * value.
   */
   ...
   *
   * @note Note that the returned value may be larger than the maximum
   * contiguous block which can be allocated.
   *
