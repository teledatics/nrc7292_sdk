...
esp_err_t
esp_event_handler_register(esp_event_base_t event_base,
                           int32_t event_id,
                           ...
                           void* event_handler_arg)
{
  ...
  return esp_event_handler_register_with(
    s_default_loop, event_base, event_id, event_handler, event_handler_arg);
}

esp_err_t
esp_event_handler_instance_register(esp_event_base_t event_base,
                                    int32_t event_id,
                                    esp_event_handler_t event_handler,
                                    void* event_handler_arg,
                             ...
                             esp_event_handler_t event_handler)
{
  ...
  return esp_event_handler_unregister_with(
    s_default_loop, event_base, event_id, event_handler);
}
                                      ...
                                      esp_event_handler_instance_t context)
{
  ...
  return esp_event_handler_instance_unregister_with(
    s_default_loop, event_base, event_id, context);
}
               ...
               TickType_t ticks_to_wait)
{
  ...
  return esp_event_post_to(s_default_loop,
                           event_base,
                           event_id,
                           event_data,
                           event_data_size,
...
esp_err_t
esp_event_isr_post(esp_event_base_t event_base,
                   int32_t event_id,
                   void* event_data,
                   size_t event_data_size,
                   BaseType_t* task_unblocked)
{
  ...
  return esp_event_isr_post_to(s_default_loop,
                               event_base,
                               event_id,
                               event_data,
                               event_data_size,
