...
extern "C"
{
  ...
  typedef enum
  {
    ...
    SYSTEM_EVENT_STA_LOST_IP, /*!< ESP32 station lost IP and the IP is reset to
                               * 0
                               */
    SYSTEM_EVENT_STA_BSS_RSSI_LOW,   /*!< ESP32 station connected BSS rssi goes
                                        below threshold */
    SYSTEM_EVENT_STA_WPS_ER_SUCCESS, /*!< ESP32 station wps succeeds in enrollee
                                        mode */
    SYSTEM_EVENT_STA_WPS_ER_FAILED,  /*!< ESP32 station wps fails in enrollee
                                      * mode
                                      */
    SYSTEM_EVENT_STA_WPS_ER_TIMEOUT, /*!< ESP32 station wps timeout in enrollee
                                        mode */
    SYSTEM_EVENT_STA_WPS_ER_PIN,     /*!< ESP32 station wps pin code in enrollee
                                      * mode
                                      */
    SYSTEM_EVENT_STA_WPS_ER_PBC_OVERLAP, /*!< ESP32 station wps overlap in
                                            enrollee mode */
    SYSTEM_EVENT_AP_START,               /*!< ESP32 soft-AP start */
    SYSTEM_EVENT_AP_STOP,                /*!< ESP32 soft-AP stop */
    SYSTEM_EVENT_AP_STACONNECTED, /*!< a station connected to ESP32 soft-AP */
    SYSTEM_EVENT_AP_STADISCONNECTED, /*!< a station disconnected from ESP32
                                        soft-AP */
    SYSTEM_EVENT_AP_STAIPASSIGNED,   /*!< ESP32 soft-AP assign an IP to a
                                        connected   station */
    SYSTEM_EVENT_AP_PROBEREQRECVED, /*!< Receive probe request packet in soft-AP
                                       interface */
    SYSTEM_EVENT_ACTION_TX_STATUS,  /*!< Receive status of Action frame
                                     * transmitted
                                     */
    SYSTEM_EVENT_ROC_DONE, /*!< Indicates the completion of Remain-on-Channel
                              operation status */
    SYSTEM_EVENT_STA_BEACON_TIMEOUT, /*!< ESP32 station beacon timeout */
    SYSTEM_EVENT_FTM_REPORT,         /*!< Receive report of FTM procedure */
    SYSTEM_EVENT_GOT_IP6,   /*!< ESP32 station or ap or ethernet interface v6IP
                               addr   is preferred */
    ...
    SYSTEM_EVENT_ETH_LOST_IP, /*!< ESP32 ethernet lost IP and the IP is reset to
                               * 0
                               */
...
#define SYSTEM_EVENT_AP_STA_GOT_IP6 SYSTEM_EVENT_GOT_IP6
  ...
  typedef union
  {
    ...
    system_event_sta_authmode_change_t
      auth_change; /*!< the auth mode of AP ESP32 station connected to changed
                    */
    system_event_sta_got_ip_t got_ip; /*!< ESP32 station got IP, first time got
                                         IP or when IP is changed */
    system_event_sta_wps_er_pin_t
      sta_er_pin; /*!< ESP32 station WPS enrollee mode PIN code received */
    system_event_sta_wps_fail_reason_t
      sta_er_fail_reason; /*!< ESP32 station WPS enrollee mode failed reason
                             code received */
    system_event_sta_wps_er_success_t
      sta_er_success; /*!< ESP32 station WPS enrollee success */
    ...
    system_event_got_ip6_t got_ip6; /*!< ESP32 station　or ap or ethernet ipv6
                                       addr state change to preferred */
  } system_event_info_t;
   ...
   *
   * @note This API is part of the legacy event system. New code should use
   * event library API in esp_event.h
   *
   * Other task/modules, such as the tcpip_adapter, can call this API to send an
   * event to event task
   *
   ...
   * @param[in] event_data the data, specific to the event occurrence, that gets
   ...
   * When using esp_event_loop APIs, it is called automatically before invoking
  ...
  /**
   * @brief  Install default event handlers for Wi-Fi interfaces (station and
   * AP)
   *
   * @note This API is part of the legacy event system. New code should use
   * event library API in esp_event.h
   ...
   *
   * @param  cb   application specified event callback, it can be modified by
   * call esp_event_set_cb
   * @param  ctx  reserved for user
   *
   * @return
   *    - ESP_OK: succeed
   ...
   *               If cb is not NULL, it will be call when an event is received,
